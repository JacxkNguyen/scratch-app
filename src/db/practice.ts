...
export const excercises: Exercise[] = [
  ...
  },
  {
    ...
    content: [
      "Đây là bài tập Scratch đơn giản nhưng cũng có thể phát triển lên thành bài toán cho các đối tượng Tiểu học, Trung học cơ sở, và Trung học phổ thông.",
      "\t- Level 1: Yêu cầu tạo một hình vuông đơn giản có kích thước cố định bằng cách vẽ từng đường thẳng của các cạnh.",
      "\t- Level 2: Yêu cầu tạo lưới ô vuông bằng cách lặp lại các ô vuông nhỏ theo một kích thước cố định, giúp các em hiểu về khái niệm vòng lặp.",
      "\t- Level 3: Tạo lưới ô vuông có kích thước tùy biến theo đầu vào của người dùng, giúp các em làm quen với biến và nhập dữ liệu.",
      "Với bài tập lập trình Scratch Tiểu học này, hãy khuyến khích các em tùy biến kích thước và số lượng ô vuông để phát triển khả năng sáng tạo và tư duy lập trình của mình.",
    ],
  },
  {
  ...
  },
  {
    title: "Trò chơi pong",
    description:
      "Đây là bài tập thú vị cho học sinh Tiểu học để tạo trò chơi Pong cổ điển trên Scratch.",
    image:
      "https://2018media.idtech.com/2023-03/pong-in-scratch-example.png?06a5dd72ce",
    content: [
      "\t- Tạo hai thanh di chuyển (Paddle) ở các vị trí trên và dưới màn hình và một quả bóng",
      "\t- Rồi lập trình cho thanh di chuyển",
      "\t- Thiết lập bóng di chuyển theo hướng ngẫu nhiên lúc bắt đầu.",
      "\t- Khi bóng chạm thanh, lập trình để nó nảy trở lại, đổi hướng ngẫu nhiên.",
      "\t- Tạo biến để lưu trữ điểm cho mỗi người chơi và Thêm âm thanh khi bóng chạm thanh để tăng tính hấp dẫn.",
    ],
  },
];
